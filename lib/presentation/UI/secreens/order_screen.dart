...
class _OrderScreenState extends State<OrderScreen> {
  ...
  void initState() {
    ...
    currentUserId = authenticationController.currentUser.id!;
    userSavedAddress =
        authenticationController.currentUser.address ?? "123 Main Street";
    addressController.text = userSavedAddress;
    _fetchCartData();
  }
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSectionTitle("📍 Delivery Address"),
                      const SizedBox(height: 10),
                      _buildAddressInput(useSavedAddress, (value) {
                        setState(() {
  ...
  Widget _buildAddressInput(bool useSavedAddress, Function(bool) onToggle) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
